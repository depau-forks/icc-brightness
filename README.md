...
This is a fork of `icc-brightness` modified to work with desktop PCs without an
integrated display.

The tool applies the ICC profile to all displays; it also allows to raise and
lower the brightness, to be bound to keyboard shortcuts.
